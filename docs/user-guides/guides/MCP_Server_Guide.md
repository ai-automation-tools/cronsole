...
| **`export_task`** | "Show me exactly what that task is registered to run", "back this task up" — or **"set this task up on my other machine"**, which asks for the *portable* format instead | `GET /api/tasks/:id/export` |
