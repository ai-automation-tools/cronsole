...
<p align="center">
  <em>Day-to-day guides for using TaskHub once it's running.</em>
</p>
...
These walk through actually *using* TaskHub — navigating the dashboard and running the
Windows agent. If you haven't set TaskHub up yet, start with
