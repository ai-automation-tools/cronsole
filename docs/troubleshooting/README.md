...
# cli_user_placeholder | you@your-domain.com     ← not mike@example.com anymore
```
...
```
Refreshing clone at C:\...\Tools\cronsole-registry
...
so *Recreate with changes* (which sends the whole tool list) is the edit path.
