...
*Last updated: 2026-07-08 (added: Settings page + non-blocking toasts + live connection-health panel; full modal toast migration + honest Sync/Import split + "synced N ago" chip; synced Windows schedules normalized to cron + null-safe run times; README visual overhaul with banner logo + live screenshots; docs hub "Start here" path).*
