...
*Last updated: 2026-07-10 (P1 complete incl. the full QA suite; P2 underway — failure notifications, agent `task:delete`, and Apply-modal upgrades (task-name + duplicate guard, presets, schedule preview) shipped; see `docs/ROADMAP.md`).*
