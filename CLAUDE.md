...
*Last updated: 2026-07-10 (P1: server-side template substitution + backend hygiene sweep + agent-auth hardening follow-ups shipped — P1 now closed except the QA suite; see `docs/ROADMAP.md`).*
