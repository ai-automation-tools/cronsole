...
export const GETTING_STARTED_STEPS: OnboardingStep[] = [
  {
    ...
    body:
      "TaskHub reads and runs your Windows tasks through a small agent on your machine. " +
  ...
  },
  {
    ...
    body:
      ...
      "TaskHub infers a category from each task's folder path (a task under \\Monitoring\\ becomes \"Monitoring\"); " +
  ...
  },
  {
    ...
    body:
      ...
      "all from TaskHub, no Task Scheduler needed. Failed runs are flagged on the card, and Run History shows the log."
  },
  {
    icon: '🧩',
    title: 'Use & grow templates',
    body:
      "The Templates tab has ready-to-use starters — fill in the blanks and TaskHub creates a real scheduled task. " +
...
export const HELP_GUIDES: HelpLink[] = [
  ...
  },
  {
    ...
    description: 'The public catalog TaskHub fetches — browse or contribute',
