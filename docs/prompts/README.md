...
|:---|:---|:---|
| [**🧩 mcp-server/**](mcp-server/README.md) | An assistant wired to the **Cronsole MCP server** (15 tools) | You want to **list, create, run, and manage real tasks** on your machine in plain English — the way most people will use Cronsole day to day. |
